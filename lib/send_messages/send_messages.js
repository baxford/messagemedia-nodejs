exports.sendMessage = function(userId, password, content, numbers, uid, tags, callback) {
  ...
  var request = sendMessageRequest(userId, password, content, numbers, uid, tags, function(request) {
    var ctx = {
      request : request,
      url : url,
      action : action,
